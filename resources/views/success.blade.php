...
<body style="background-color: #d7d7d7" class="generic-template" style="-moz-osx-font-smoothing: grayscale; -webkit-font-smoothing: antialiased; background-color: #d7d7d7; margin: 0; padding: 0;">
    <!-- Header Start -->
    <div class="bg-white header" bgcolor="#ffffff" style="background-color: white; width: 100%;">
        <table align="center" bgcolor="#ffffff" style="border-left: 10px solid white; border-right: 10px solid white; max-width: 700px; width: 100%;">
            <tr height="80">
                <td align="left" class="vertical-align-middle" style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 16px; vertical-align: middle;">
                    <img src="{{asset('img/Logo.jpeg')}}" alt="" width="270" style="height: 96px !important;border: 0; font-size: 0; margin: 0; max-width: 100%; padding: 0;">
    ...
    <!-- Content Start -->
    <table cellpadding="0" cellspacing="0" cols="1" style="background-color: #d7d7d7" align="center" style="max-width: 700px;">
        ...
        <tr style="background-color: #d7d7d7">
            <td style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 16px; vertical-align: top;">
                <!-- Seperator Start -->
                <table cellpadding="0" cellspacing="0" cols="1" style="background-color: #d7d7d7" align="center" style="max-width: 600px; width: 100%;">
                    <tr style="background-color: #d7d7d7">
                ...
                <table align="center" cellpadding="0" cellspacing="0" cols="3" bgcolor="white" class="bordered-left-right" style="border-left: 10px solid #d7d7d7; border-right: 10px solid #d7d7d7; max-width: 700px; width: 100%;">
                    <tr height="50">
                    ...
                    <tr align="center">
                        <td width="36" style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 16px; vertical-align: top;"></td>
                        <td class="text-primary" style="color: #F16522; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 16px; vertical-align: top;">
                            <h1 style="color: #F16522; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 30px; font-weight: 700; line-height: 34px; margin-bottom: 0; margin-top: 0;">THANK YOU!</h1>
                        </td>
                        <td width="36" style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 16px; vertical-align: top;"></td>
                    </tr>
                    <tr height="30">
                    ...
                    <tr align="left">
                        ...
                        <td style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 16px; vertical-align: top;">
                            ...
                            <p style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 26px; margin: 0;text-transform: uppercase;"><strong></strong>
                                Your booking has been confirmed with the transaction - {{$response['recieptId']}}. </p>
                            <br>
                            <p style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 22px; margin: 0; ">
                                <br />

                                <i> Just a second we are sending your booking deatils to your email. </i><br />
                            </p>
                            <br>
                            <p style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 22px; margin: 0;text-transform: capitalize;">
                    ...
                    <tr align="center">
                        ...
                        <td style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 16px; vertical-align: top;">
                            ...
                            <p style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 22px; margin: 0;"> </p>
                            <p style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 22px; margin: 0;">  <a href="{{url('/')}}" style="outline: none;text-decoration: none;">
                                <button class="btn btn-success" style="	background-color: #03A853;
			width: 150px;
			height: 48px;
			font-size: 16px;
			color: #fff;
	...
	">Go To Home</button></a></p>
                    ...
                    <td width="36" style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 16px; vertical-align: top;"></td>
                        ...
                        <td colspan="3" style="color: #464646;font-size: 14px; line-height: 16px; vertical-align: top;">
                            <a href="{{url('/')}}" style="outline: none;text-decoration: none;">
                                <button class="btn btn-success" style="	background-color: #03A853;
			width: 150px;
			height: 48px;
			font-size: 16px;
    ...
    <div class="bg-gray-dark footer" bgcolor="#464646" height="165" style="background-color: #464646; width: 100%;">
        <table align="center" bgcolor="#464646" style="max-width: 600px; width: 100%;">
            ...
            <tr>
                <td align="center" style="color: #464646;
            ...
            <tr height="10">
                <td style="color: #464646; font-family: 'Helvetica Neue', 
                Helvetica, Arial, sans-serif; font-size: 14px; line-height: 16px; vertical-align: top;"></td>
            </tr>
