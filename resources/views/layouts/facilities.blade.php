			...
			<div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12" >
                    ...
                    @forelse($labs as $lab)
                        ...
                        <div class="item">
                            <a href="#" 
                        title="This is an image title" data-lightbox-gallery="gallery1" data-lightbox-hidpi="img/works/1@2x.jpg">
                        <img src="{{asset('Image/'.$lab->image) }}" class="img-responsive" alt="img"></a></div>
                        @empty
                        @endforelse
