        ...
        <div class="sidebar-content">
            <div class="nav-container">
                <nav id="main-menu-navigation" class="navigation-main">
                    ...
                    <div class="nav-item has-sub">
                        <a href="javascript:void(0)"><i class="ik ik-list"></i><span>Category</span> <span
                                class="badge badge-danger"></span></a>
                        <div class="submenu-content">
                    ...
                    <div class="nav-item has-sub">
                        <a href="javascript:void(0)"><i class="ik ik-list"></i><span>Find Test Organ</span> <span
                                class="badge badge-danger"></span></a>
                        <div class="submenu-content">
                    ...
                    <div class="nav-item has-sub">
                        <a href="javascript:void(0)"><i class="ik ik-list"></i><span>Parent Test</span> <span
                                class="badge badge-danger"></span></a>
                        <div class="submenu-content">
                    ...
                    <div class="nav-item has-sub">
                        <a href="javascript:void(0)"><i class="ik ik-list"></i><span>Sub Test</span> <span
                                class="badge badge-danger"></span></a>
                        <div class="submenu-content">
                            <a href="<?php echo e(route('subtest.create')); ?>" class="menu-item">Create</a>
                            <a href="<?php echo e(route('subtest.show')); ?>" class="menu-item">All Sub Test</a>

                        </div>
                    </div>

                    <div class="nav-item has-sub">
                        <a href="javascript:void(0)"><i class="ik ik-list"></i><span>Lab</span> <span
                                class="badge badge-danger"></span></a>
                        <div class="submenu-content">
                    ...
                    <div class="nav-item has-sub">
                        <a href="javascript:void(0)"><i class="ik ik-list"></i><span>Package</span> <span
                                class="badge badge-danger"></span></a>
                        <div class="submenu-content">
...
<?php /**PATH C:\xampp\htdocs\callabs\resources\views/admin/layouts/sidebar.blade.php ENDPATH**/ ?>