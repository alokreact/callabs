                        ...
                        <li class='cbp-item <?php echo e($package->category); ?>' style="height: 460px !important; width: 300px !important">
                            ...
                            <div class="pricing-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp">
                                <div class="inner-box" style="height: 406px !important; width:290px !important">
                                    ...
                                    <div class="price-box">
                                        <div class="title">
                                            <a href="<?php echo e(url('/package')); ?>"> <?php echo e($package-> package_name); ?></a>
                                        </div>
                                        ...
                                        <span>Include Tests - <?php echo e($package-> no_of_tests); ?></span>
                                    ...
                                    <ul class="features cbp-singlePage cbp-l-grid-team-name">
                                        ...
                                        <li> <i class="fa-solid fa-circle-chevron-right"></i> <?php echo e($value); ?></li>
                                        <?php $i++; ?>
                                    ...
                                    <div class="btn-box">
                                        ...
                                        <a href="<?php echo e(route('add_to_cart', $package->id)); ?>" class="theme-btn" role="button">Add to cart</a>
                                    </div>
                                </div>
                            </div>
                        </li>
