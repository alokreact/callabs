                ...
                <div class="widget">
                    <div class="widget-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="state">
                                <h6>Patients</h6>
                                <h2><?php echo e(App\User::where('role_id', 3)->count()); ?></h2>
                            </div>
                            <div class="icon">
                ...
                <div class="widget">
                    <div class="widget-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="state">
                                <h6>Doctors</h6>
                                <h2><?php echo e(App\User::where('role_id', 1)->count()); ?></h2>
                            </div>
                            <div class="icon">
                ...
                <div class="widget">
                    <div class="widget-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="state">
                                <h6>Roles</h6>
                                <h2><?php echo e(App\Role::count()); ?></h2>
                            </div>
                            <div class="icon">
                ...
                <div class="widget">
                    <div class="widget-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="state">
                                <h6>Booking</h6>
                                <h2><?php echo e(App\Booking::count()); ?></h2>
                            </div>
                            <div class="icon">
                ...
                <div class="widget">
                    <div class="widget-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="state">
                                <h6>Prescription</h6>
                                <h2><?php echo e(App\Prescription::count()); ?></h2>
                            </div>
                            <div class="icon">
                ...
                <div class="widget">
                    <div class="widget-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="state">
                                <h6>Department</h6>
                                <h2><?php echo e(App\Department::count()); ?></h2>
                            </div>
                            <div class="icon">
...
<?php /**PATH C:\xampp\htdocs\callabs\resources\views/admin/layouts/content.blade.php ENDPATH**/ ?>