...
<div class="row justify-content-center">
    <div class="col-lg-10">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form class="forms-sample" method="post" action="<?php echo e(route('labpackage.update', [$lab->id])); ?>" enctype="multipart/form-data"><?php echo csrf_field(); ?>

                    <div class="row">
                        <div class="col-lg-6">
                            <label for="">Lab name</label>
                            <input type="text" name="lab_name" readonly class="form-control <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($lab->lab_name); ?>">
...
unset($__errorArgs, $__bag); ?> col-md-12">
                                ...
                                <?php if(!in_array($sub_test->id,$selected)): ?>

                                <option value="<?php echo e($sub_test->id); ?>">
                                    <?php echo e($sub_test->sub_test_name); ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\callabs\resources\views/admin/lab/labpackageedit.blade.php ENDPATH**/ ?>