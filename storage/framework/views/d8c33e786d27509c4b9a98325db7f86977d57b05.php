                    ...
                    <?php endif; ?>
                        ...
                        <div class="details row">
                            <div class="input col-lg-6">
                                ...
                                <a href="<?php echo e(asset('Image/'.$order[0]->report_url)); ?>">  <input type="button" placeholder="Enter your Name" name="name" value="DOWNLOAD"></a>
...
<?php echo $__env->make('layouts.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\callabs\resources\views/dashboard/downloadreport.blade.php ENDPATH**/ ?>