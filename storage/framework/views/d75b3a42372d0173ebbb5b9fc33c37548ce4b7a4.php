...
<div class="container">
			<div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12" >
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $labs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lab): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <img src="<?php echo e(asset('Image/'.$lab->image)); ?>" class="img-responsive" alt="img"></a></div>
	...
	<!-- /Section: works -->
	<?php /**PATH C:\xampp\htdocs\callabs\resources\views/layouts/facilities.blade.php ENDPATH**/ ?>