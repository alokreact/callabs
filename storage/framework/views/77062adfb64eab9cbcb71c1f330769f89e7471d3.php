            ...
            <div class="row">
                ...
                <div class="card mb-4 col-md-12" style="background-color:#fff; padding:0px;margin:20px; width:96%;height:200px">
                    <div class="card-header" style="font-size: 20px;line-height:36px">
                        ...
                        <?php echo e((strlen($subtest->sub_test_name) > 65) ? substr($subtest->sub_test_name,0,10).'...' : $subtest->sub_test_name); ?>
                    ...
                    <div class="card-body" style="padding: 10px;">
                        ...
                        <h6 class="mb-1" style="font-size:20px;line-height:40px">
                             <i class="fa fa-thermometer" aria-hidden="true"></i> <?php echo e($subtest->sample_type); ?>

                            <br />

                            <i class="fa fa-flask" aria-hidden="true"></i> 
                            <span class="mb-1" style="font-size:20px;line-height:40px"><?php echo e($subtest->volume); ?> </span></h5>
