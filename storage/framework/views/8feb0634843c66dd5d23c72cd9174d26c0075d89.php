...
<?php echo $__env->make('layouts.components.options', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<!-- Section: works -->
 <?php echo $__env->make('layouts.facilities', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<!-- /Section: works -->
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-6 col-md-3">
                <div class="partner">
                    <a href="#">
                        <img src="<?php echo e(asset('Image/'.$lab->image)); ?>" alt=""  width="210" height="70"/></a>
                </div>
            </div>
