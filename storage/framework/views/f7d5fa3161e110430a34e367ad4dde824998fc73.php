                    ...
                    <form method="post" action="<?php echo e(route('payment')); ?>">
                        ...
                        <div class="details row">
                            ...
                            <div class="input col-lg-6">
                                ...
                                <span> <input type="radio" placeholder="Amount" name="pay_option" value="1" style="width:14px;height: 16px;
                                float: left;
      clear: none;padding:7px;margin:4px 3px 0px 6px;">
                                    PAY NOW
                                </span>

                                <span>
                                    <input type="radio" placeholder="Amount" name="pay_option" value="2" style="width:14px;height: 16px;padding: 7px; float: left;
      clear: none;
